...
class Hangman(object):
    ...
    def fromUserInput(cls):
        ...
        obj.players = getInt("How many players",1, 4)
    
        if obj.players >1:
            obj.chooser = input("Who will choose the word type player name or type computer?
")
            if obj.chooser = "computer": obj.randomWord()                     
